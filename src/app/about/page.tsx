  ...
  return (
    <div className="pt-20 pb-24">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <span className="text-brand-accent text-[10px] font-bold uppercase tracking-[0.3em] mb-4 block">Our Story</span>
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={i} className="flex items-start space-x-4 p-6 bg-white rounded-3xl shadow-sm">
                  <div className="w-12 h-12 bg-brand-bg rounded-2xl flex items-center justify-center text-brand-accent shrink-0">
                    <item.icon size={24} />
                  </div>
                  <div>
